#!/usr/bin/env python3
"""Offline revalidation of actual A/B outputs under a final host snapshot."""
...
def main():
    ...
    write(ROOT/'final-host-replay.json',{'status':'verified','provider_calls':0,'provider_outputs_reused_unchanged':True,
        'actual_provider_runtime':'runtime-A and runtime-B, as bound by the run manifest; not runtime-final-host',
