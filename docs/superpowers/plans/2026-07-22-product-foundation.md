...
- Preserve dates, sources, verdicts, overlap values, categories, URLs, identifiers, model names, commands, counts, thresholds, and table values.
- Keep these machine tokens byte-stable: `strong-accept`, `accept-w-rev`, `reject`, `low`, `medium`, `high`, `novelty-dead`, `evidence-incomplete`, `design-fixable`, `ceiling-limited`, `hunt`, and `weekly`.
...
- Produces: fluent English theme, idea, and reason fields with unchanged row order and machine columns.

- [ ] **Step 1: Rewrite only columns 3, 4, and 6 for rows 2-178**

Use the exact English theme vocabulary. Preserve tabs, all other columns, URLs, identifiers, digits, percentages, comparison symbols, and epistemic strength.
...
- [ ] **Step 1: Rewrite only columns 3, 4, and 6 for rows 179-355**
...
- Produces: a fully English ledger with preserved stable projections.

- [ ] **Step 1: Rewrite only columns 3, 4, and 6 for rows 356-532**
